...
3. If the member agrees, go to the Listener Support Room (the question mark button <span style="display: inline-block; width: 1.2em; height: 1.2em; text-align: center; border: 1px solid #aaa; border-radius: .6em; color: #aaa;">?</span> at the top left of the chat.
