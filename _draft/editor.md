...
<div style="font-family: monospace; overflow-wrap: break-word; width: 100%; background: #eee; border: 1px solid #aaa;">javascript:with(document)void(head.appendChild(createElement('script')).src='https://greasyfork.org/scripts/36395-7-cups-forum-inline-editor/code/7%20Cups%20-%20forum%20inline%20editor.user.js</div>
