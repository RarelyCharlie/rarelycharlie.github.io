...
There's nothing else to do. The forum categories you see in the list above are automatically available when you use the Listener Information search engine in this web browser's current profile. (If the Listener Information page is already open, refresh it to load any changes you've made to the index.)
