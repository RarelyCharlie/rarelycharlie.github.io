...
layout: default
---
<style>#content p.box {color: #a9ae; font-size: 150%; font-weight: bold; line-height: 1.15em; margin: 0 1ex; background: #f4f4ff; padding: 1ex; text-align: center; width: 40%; float: right; box-shadow: 4px 4px 12px rgba(0, 0, 0, .2);}</style>
