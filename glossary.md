...
This is an unofficial and experimental glossary of the terminology used at [7 Cups](http://7cups.com/), compiled and maintained by [@RarelyCharlie](https://7cups.com/@RarelyCharlie). For more information, or to report errors and omissions, see the forum thread: [A 7 Cups Glossary]({{ page.feedback }})
{: .preface}
