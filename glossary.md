...
# counseling
Any of various professional methodologies for helping people with mental or emotional difficulties, particularly, but not exclusively, for the ordinary difficulties of life, as opposed to mental illness.
...
# deactivate
To turn an ~~account~~ off temporarily so that its ~~name~~ becomes ~~Unknown~~ and it cannot access ~~7 Cups~~ (except to reactivate the account).
...
# discussion
A scheduled and often somewhat formal session in a ~~chatroom~~, led by one or more designated people and with a focus on a particular topic.
...
# EST
Eastern Standard Time, often loosely used to mean whatever time it is on the Eastern coast of the United States, in New York for example, whether or not daylight saving is in effect. Times in ~~7 Cups~~ are normally given in EST (or EDT when daylight saving time is in effect) to make it easier for people around the world to convert them to their own time zone.
...
# GlenM
~~Listener|listener~~ ~~name~~ of ~~7 Cups'|7 Cups~~ founder Glen Moriarty.
...
# Incapsula
A cloud-based system that provides faster response times and better security for ~~7 Cups~~. Only visible when something goes wrong and the name Incapsula can be seen in the error message.
...
# profile
A page containing information about a ~~member~~, ~~listener~~ or ~~therapist~~ ~~account~~, or the owner-supplied part of the information on that page. ~~Guest|guest~~ accounts do not have profiles. Some of the information is supplied by the owner of the account and some by the system.
...
# settings
A page in the ~~website~~ or ~~app~~ where you can specify details about your ~~account's|account~~.
...
# therapy
Any of various professional methodologies for helping people with mental or emotional difficulties, particularly, but not exclusively, for mental illness as opposed to the ordinary difficulties of life. Also known as psychotherapy to distinguish it from physical therapies.
...
# Twisha
~~Listener|listener~~ ~~name~~ of ~~7 Cups'|7 Cups~~ ~~staff~~ member Twisha Anand.
